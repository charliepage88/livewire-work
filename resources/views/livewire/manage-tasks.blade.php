    ...
    <div>
        @foreach($tasks as $i => $task)
            <div class="flex flex-col task-row" data-id="{{ $task['id'] }}">
                @error('editForm.label') <div class="w-full my-3 text-red-500"><span class="error">{{ $message }}</span></div> @enderror
                @error('editForm.hours') <div class="w-full my-3 text-red-500"><span class="error">{{ $message }}</span></div> @enderror
                ...
                <div class="w-full flex mb-3 items-center">
                    ...
                    @if ($is_editing === $task['id'])
                        <div class="flex items-start mr-6">
                            <div class="flex items-center h-8">
                                <input wire:model="editForm.is_done" type="checkbox" class="w-8 h-8 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800">
                            </div>
                        </div>
                    @endif
                    ...
                    {{-- label --}}
                    @if ($is_editing === $task['id'])
                        <input wire:model="editForm.label" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light mr-6 pr-6" required>
                    @else
                    ...
                    @if ($is_editing === $task['id'])
                        <div class="relative font-white mr-6">
                            ...
                            <input wire:model="editForm.hours" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-12 p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    @else
                    ...
                    @if ($is_editing === $task['id'])
                        <div class="flex items-start">
                            <div class="flex items-center h-8">
                                <input wire:model="editForm.is_time_in" type="checkbox" class="w-8 h-8 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800">
                            </div>
                        </div>
                    @else
                        <div class="w-32 text-right pl-2">
