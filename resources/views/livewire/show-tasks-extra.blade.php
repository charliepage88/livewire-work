<div>
    <div class="flex flex-col" x-data="{ is_editing: @entangle('is_editing'), is_deleting: @entangle('is_deleting') }">
        ...
        <div class="w-full flex mb-3">
            {{-- is_done --}}
            <span class="w-auto inline-block text-white font-bold mr-4" x-show="!is_editing && $wire.extraTask.is_done">
            ...
            {{-- label --}}
            <span class="w-auto flex-grow inline-block text-white mr-4" x-show="!is_editing" x-text="$wire.extraTask.label"></span>
            ...
            {{-- hours --}}
            <span class="w-auto inline-block text-white mr-4" x-show="!is_editing" x-text="$wire.extraTask.hours + ' hour(s)'"></span>
            ...
            {{-- is_time_in --}}
            <span class="w-auto inline-block text-white font-bold" x-show="!is_editing && !$wire.extraTask.is_time_in">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
