<div>
    <div class="flex flex-col task-row" data-id="{{ $task->id }}" x-data="{ is_editing: @entangle('is_editing'), is_deleting: @entangle('is_deleting') }">
        ...
        <div class="w-full flex mb-3">
            ...
            <div x-show="!is_editing" class="w-48 text-right pl-2">
